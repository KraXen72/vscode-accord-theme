...
const baselinePath = path.join(root, "third_party", "vscode-dark-modern", "ui-style.json");
...
const syntax = {
  ...
  "string.special": { color: "#CE9178" }, "string.special.symbol": { color: green },
...
const theme = {
  ...
  name: "Accord",
  author: "KraXen72",
  themes: [{ name: "Accord", appearance: "dark", style: { ...baseline, syntax } }],
};
